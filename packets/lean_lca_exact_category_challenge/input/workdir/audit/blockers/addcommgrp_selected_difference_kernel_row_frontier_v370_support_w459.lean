...
/-!
W459: selected difference kernel row frontier for W456.

Seed: `71a67c3f23e76f870423b57c`.

This file keeps W456's checked local W452/W453 support shapes and specializes
the remaining kernel-row input to the categorical kernel of the selected
difference map.
-/
...
namespace AddCommGrpSelectedDifferenceKernelRowFrontierV370SupportW459
...
/-- W459 checked support state. -/
structure AddCommGrpSelectedDifferenceKernelRowFrontierV370SupportState : Type where
  seed : String
...
/-- Current checked support state for W459. -/
def currentAddCommGrpSelectedDifferenceKernelRowFrontierV370SupportState :
    AddCommGrpSelectedDifferenceKernelRowFrontierV370SupportState where
  seed := supportSeed
  checkedDeclarations :=
    ["supportSeed",
...
theorem currentAddCommGrpSelectedDifferenceKernelRowFrontierV370SupportState_productSuccess :
    currentAddCommGrpSelectedDifferenceKernelRowFrontierV370SupportState.productSuccessClaimed =
      false :=
  rfl
...
#check currentAddCommGrpSelectedDifferenceKernelRowFrontierV370SupportState_productSuccess

end Checks

end AddCommGrpSelectedDifferenceKernelRowFrontierV370SupportW459
