...
/-!
W899 feeds the W896 closed-map closedness-fields comparison stable-ExactAt
...
/--
W899 names the W856 derivation used by the closed-map branch route.
-/
@[reducible]
def endpointForgetPreservesHomologyOfClosedMapFieldsW899
...
/--
W899 removes W896's explicit endpoint forgetful homology-preservation field.
The W519 mapped-cokernel closed-map provider supplies it through W856.
-/
structure MetrizableWppClosedMapEndpointHomologyFreeLeavesW899 :
    Type 2 where
  rightOpenBoundary :
...
/-- W899 projects the W896 leaves, deriving the endpoint homology field. -/
def closedMapClosednessFieldLeavesOfEndpointHomologyFreeW899
...
/-- W899 W733 concrete leaves after deriving endpoint homology preservation. -/
def concreteLeavesOfClosedMapEndpointHomologyFreeComparisonW899
    (leaves : MetrizableWppClosedMapEndpointHomologyFreeLeavesW899) :
...
/-- W899 W732 route data after deriving endpoint homology preservation. -/
def routeDataProviderOfClosedMapEndpointHomologyFreeComparisonW899
    (leaves : MetrizableWppClosedMapEndpointHomologyFreeLeavesW899) :
...
/--
W899 direct bounded left calculus through the latest W896 comparison stable
ExactAt route.
-/
theorem
...
/--
W899 bounded derived infinity-category package through the latest W896
...
/-- W899 exposes W896's fields except the W856-derived endpoint homology field. -/
def closedMapEndpointHomologyFreeComparisonStableExactAtInputNamesW899 :
    List String :=
...
theorem closedMapEndpointHomologyFreeComparisonStableExactAtInputNamesW899_count :
    closedMapEndpointHomologyFreeComparisonStableExactAtInputNamesW899.length =
      37 :=
  rfl

/-- Current checked W899 state. -/
structure MetrizableClosedMapEndpointHomologyFreeComparisonStableExactAtRouteStateW899 :
    Type where
  seed : String
...
def currentMetrizableClosedMapEndpointHomologyFreeComparisonStableExactAtRouteStateW899 :
    MetrizableClosedMapEndpointHomologyFreeComparisonStableExactAtRouteStateW899
    where
  seed :=
    "w899-closed-map-endpoint-homology-free-comparison-stable-exact-at"
  declarations :=
    ["MetrizableWppClosedMapEndpointHomologyFreeLeavesW899",
      "endpointForgetPreservesHomologyOfClosedMapFieldsW899",
      "closedMapClosednessFieldLeavesOfEndpointHomologyFreeW899",
      ...
      "directBoundedLeftCalculusOfClosedMapEndpointHomologyFreeComparisonStableExactAtW899",
      "boundedDerivedInfinityCategoryOfClosedMapEndpointHomologyFreeComparisonStable\
        ExactAtW899",
  ...
  endpointHomologyResult :=
    "proved: W519 mapped explicit cokernel closed-map data derives\
      endpoint forgetful homology preservation via W856"
  exactAtResult :=
    "proved: closed-map endpoint-homology-free fields feed the W896 stable ExactAt route"
  removedInputs :=
...
theorem currentW899ClosedMapEndpointHomologyFreeComparisonStableExactAtRoute_productSuccess :
    (let state :=
        currentMetrizableClosedMapEndpointHomologyFreeComparisonStableExactAtRouteStateW899;
