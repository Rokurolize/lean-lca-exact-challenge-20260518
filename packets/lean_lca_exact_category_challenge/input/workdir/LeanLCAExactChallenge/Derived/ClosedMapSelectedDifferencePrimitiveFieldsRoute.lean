...
/-!
W922 feeds the W921 closed-map mapped-cokernel-primitive-fields route while
exposing the selected-difference projection `IsClosedMap` leaves as primitive
closed-set image propositions.
-/
...
/-- W922 primitive form of the selected-difference π₁ closed-map field. -/
abbrev selectedDifferenceClosedMapPi1PrimitiveW922
    (S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0}) : Prop :=
  ∀ U : Set ((S.obj ordinarySourceIndexW484).X₁),
    IsClosed U →
      IsClosed
        ((selectedMetrizableDifferenceπ₁W481 S :
          (S.obj ordinarySourceIndexW484).X₁ →
            (S.obj ordinaryTargetIndexW484).X₁) '' U)

/-- W922 primitive form of the selected-difference π₂ closed-map field. -/
abbrev selectedDifferenceClosedMapPi2PrimitiveW922
    (S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0}) : Prop :=
  ∀ U : Set ((S.obj ordinarySourceIndexW484).X₂),
    IsClosed U →
      IsClosed
...
/-- W922 primitive form of the selected-difference π₃ closed-map field. -/
abbrev selectedDifferenceClosedMapPi3PrimitiveW922
    (S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0}) : Prop :=
  ∀ U : Set ((S.obj ordinarySourceIndexW484).X₃),
    IsClosed U →
      IsClosed
...
/-- W922 assembles the selected-difference π₁ closed-map field. -/
abbrev selectedDifferenceClosedMapPi1OfPrimitiveW922
    (closedMapPi1 :
    ...
    ∀ S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0},
      IsClosedMap
        (selectedMetrizableDifferenceπ₁W481 S :
          (S.obj ordinarySourceIndexW484).X₁ →
            (S.obj ordinaryTargetIndexW484).X₁) := by
  intro S
  simpa [selectedDifferenceClosedMapPi1PrimitiveW922, IsClosedMap] using
    closedMapPi1 S

/-- W922 assembles the selected-difference π₂ closed-map field. -/
abbrev selectedDifferenceClosedMapPi2OfPrimitiveW922
    (closedMapPi2 :
      ∀ S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0},
      ...
      IsClosedMap
        (selectedMetrizableDifferenceπ₂W481 S :
          (S.obj ordinarySourceIndexW484).X₂ →
            (S.obj ordinaryTargetIndexW484).X₂) := by
  intro S
  simpa [selectedDifferenceClosedMapPi2PrimitiveW922, IsClosedMap] using
    closedMapPi2 S

/-- W922 assembles the selected-difference π₃ closed-map field. -/
abbrev selectedDifferenceClosedMapPi3OfPrimitiveW922
    (closedMapPi3 :
      ∀ S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0},
      ...
      IsClosedMap
        (selectedMetrizableDifferenceπ₃W481 S :
          (S.obj ordinarySourceIndexW484).X₃ →
            (S.obj ordinaryTargetIndexW484).X₃) := by
  intro S
  simpa [selectedDifferenceClosedMapPi3PrimitiveW922, IsClosedMap] using
    closedMapPi3 S

/--
W922 replaces W921's selected-difference projection `IsClosedMap` fields with
the primitive closed-set image propositions hidden by that definition.
-/
structure MetrizableWppClosedMapSelectedDifferencePrimitiveFieldLeavesW922 :
    Type 2 where
  rightOpenBoundary :
...
/-- W922 projects W921 leaves from the selected-difference primitive fields. -/
def w921LeavesOfSelectedDifferencePrimitiveFieldsW922
    (leaves :
  ...
  closedMapPi1 :=
    selectedDifferenceClosedMapPi1OfPrimitiveW922 leaves.closedMapPi1
  closedMapPi2 :=
    selectedDifferenceClosedMapPi2OfPrimitiveW922 leaves.closedMapPi2
  closedMapPi3 :=
    selectedDifferenceClosedMapPi3OfPrimitiveW922 leaves.closedMapPi3
...
/-- W922 W733 concrete leaves after projecting W921 leaves. -/
def concreteLeavesOfClosedMapSelectedDifferencePrimitiveFieldsW922
...
/-- W922 W732 route data after projecting W921 leaves. -/
def routeDataProviderOfClosedMapSelectedDifferencePrimitiveFieldsW922
    (leaves : MetrizableWppClosedMapSelectedDifferencePrimitiveFieldLeavesW922) :
    MetrizableWppBoundaryRelationTargetClosednessNormalizedDataProviderW732 :=
  routeDataProviderOfClosedMapMappedCokernelPrimitiveFieldsW921
    (w921LeavesOfSelectedDifferencePrimitiveFieldsW922 leaves)

theorem directBoundedLeftCalculusOfClosedMapSelectedDifferencePrimitiveFieldsW922
    (leaves : MetrizableWppClosedMapSelectedDifferencePrimitiveFieldLeavesW922) :
...
/-- W922 exposes W921's selected-difference closed-map fields as primitives. -/
def closedMapSelectedDifferencePrimitiveFieldsInputNamesW922 :
    List String :=
...
theorem closedMapSelectedDifferencePrimitiveFieldsInputNamesW922_count :
    closedMapSelectedDifferencePrimitiveFieldsInputNamesW922.length =
      39 :=
  rfl

/-- Current checked W922 state. -/
structure MetrizableClosedMapSelectedDifferencePrimitiveFieldsRouteStateW922 :
    Type where
  seed : String
  declarations : List String
  selectedDifferencePrimitiveFieldResult : String
  exactAtResult : String
  refinedInputs : List String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentMetrizableClosedMapSelectedDifferencePrimitiveFieldsRouteStateW922 :
    MetrizableClosedMapSelectedDifferencePrimitiveFieldsRouteStateW922
    where
  seed :=
    "w922-closed-map-selected-difference-primitive-fields-\
      mapped-cokernel-primitive-fields"
  declarations :=
    ["MetrizableWppClosedMapSelectedDifferencePrimitiveFieldLeavesW922",
      "selectedDifferenceClosedMapPi1PrimitiveW922",
      "selectedDifferenceClosedMapPi2PrimitiveW922",
      "selectedDifferenceClosedMapPi3PrimitiveW922",
      "selectedDifferenceClosedMapPi1OfPrimitiveW922",
      "selectedDifferenceClosedMapPi2OfPrimitiveW922",
      "selectedDifferenceClosedMapPi3OfPrimitiveW922",
      "w921LeavesOfSelectedDifferencePrimitiveFieldsW922",
      ...
      "boundedDerivedInfinityCategoryOfClosedMapSelectedDifferencePrimitiveFieldsW922",
      "closedMapSelectedDifferencePrimitiveFieldsInputNamesW922",
      "closedMapSelectedDifferencePrimitiveFieldsInputNamesW922_count"]
  selectedDifferencePrimitiveFieldResult :=
    "proved: primitive closed-set image quantifiers supply W921's selected-\
      difference projection IsClosedMap fields"
  exactAtResult :=
    "proved: closed-map selected-difference-primitive-fields\
      ...
      component-fields mapped-cokernel-field fields feed the W921 stable\
      ExactAt route"
  refinedInputs :=
    ["primitive selected-difference pi1 closed-set image condition",
      "primitive selected-difference pi2 closed-set image condition",
...
theorem currentW922ClosedMapSelectedDifferencePrimitiveFieldsRoute_productSuccess :
    (let state :=
        currentMetrizableClosedMapSelectedDifferencePrimitiveFieldsRouteStateW922;
