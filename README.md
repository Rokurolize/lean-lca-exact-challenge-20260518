...
W1166 is the latest checked nonterminal increment. It constructs W1165's W1012 endpoint-localized-unit input surface from the W1013 normalized-source/endpoint-localized-unit provider route, then delegates through W1165 and the previously checked route chain. The explicit input surface is the 4 W1013 normalized-source/endpoint-localized-unit inputs. Product success remains false.
