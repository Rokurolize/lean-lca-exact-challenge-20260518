...
- ローカルmathlib `Mathlib/CategoryTheory/Triangulated/Subcategory.lean`: `ObjectProperty.trW`と、object propertyがtriangulated subcategoryである場合に`trW.HasLeftCalculusOfFractions`が得られるAPIを確認し、v79からv83の条件付きVerdier局所化frontierに使った。
