...
- ローカルmathlib `Mathlib/CategoryTheory/Localization/LocalizerMorphism.lean`: `LocalizerMorphism`と`localizedFunctor`を確認し、direct bounded exact localizationからhomotopy/Verdier pullback localizationへの比較functorを作るために使った。
