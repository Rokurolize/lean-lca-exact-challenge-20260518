...
- ローカルmathlib `Mathlib/CategoryTheory/Triangulated/Subcategory.lean`: `ObjectProperty.trW`と、object propertyがtriangulated subcategoryである場合に`trW.HasLeftCalculusOfFractions`が得られるAPIを確認し、v79からv82の条件付きleft calculus frontierに使った。
