...
2. Finish the corrected Drinfeld quotient: prove the general differential squares to zero, bundle DG composition and units, prove the quotient universal property, and derive the objectwise mapping-space comparison needed for `MetrizableOrdinaryToDirectDGBaseChangeIsEquivalence`.
