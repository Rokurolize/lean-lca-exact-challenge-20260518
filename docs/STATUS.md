...
2. Prove the enriched universal property of the packaged corrected Drinfeld quotient and derive the objectwise mapping-space comparison needed for `MetrizableOrdinaryToDirectDGBaseChangeIsEquivalence`.
