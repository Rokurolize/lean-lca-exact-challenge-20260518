...
2. Prove extension-after-restriction uniqueness, package both inverse laws as the enriched universal property of the corrected Drinfeld quotient, and derive the objectwise mapping-space comparison needed for `MetrizableOrdinaryToDirectDGBaseChangeIsEquivalence`.
