...
/-!
W931 feeds the W930 closed-map target-compact-no-univ-membership-primitive-field
route while exposing the bounded-homotopy localized adjunction unit membership as
the objectwise predicate hidden by `MorphismProperty.functorCategory`.
-/
...
/--
W931 primitive objectwise form of the bounded-homotopy localized adjunction unit
membership field.
-/
abbrev boundedHomotopyLocalizedUnitObjectwisePrimitiveW931
  ...
  ∀ X : BoundedComplexCategory MetrizableLCA.{0},
    boundedHomotopyExactWeakEquivalence MetrizableLCA.{0}
      (boundedHomotopyLocalizedAdjunction.unit.app X)

/-- W931 assembles the W930 functor-category unit membership field. -/
abbrev boundedHomotopyLocalizedUnitMemOfObjectwisePrimitiveW931
    (boundedHomotopyLocalizedRightAdjoint :
      MorphismProperty.Localization
          ((exactAcyclicHomotopyIsoClosure MetrizableLCA.{0}).trW) ⥤
        BoundedComplexCategory MetrizableLCA.{0})
    ...
    (boundedHomotopyExactWeakEquivalence MetrizableLCA.{0}).functorCategory
      (BoundedComplexCategory MetrizableLCA.{0})
      boundedHomotopyLocalizedAdjunction.unit := by
  intro X
  exact boundedHomotopyLocalizedUnitObjectwise X

/--
W931 replaces W930's bounded-homotopy localized adjunction unit membership with
the equivalent objectwise primitive exposed by `MorphismProperty.functorCategory`.
-/
structure MetrizableWppClosedMapTargetCompactObjectwiseUnitPrimitiveFieldLeavesW931 :
    Type 2 where
  rightOpenBoundary :
...
/-- W931 projects W930 leaves from the objectwise unit-membership primitive. -/
def w930LeavesOfTargetCompactObjectwiseUnitPrimitiveFieldsW931
    (leaves :
  ...
  boundedHomotopyLocalizedUnitMem :=
    boundedHomotopyLocalizedUnitMemOfObjectwisePrimitiveW931
      leaves.boundedHomotopyLocalizedRightAdjoint
      leaves.boundedHomotopyLocalizedAdjunction
      leaves.boundedHomotopyLocalizedUnitObjectwise

/-- W931 W733 concrete leaves after projecting W930 leaves. -/
def concreteLeavesOfClosedMapTargetCompactObjectwiseUnitPrimitiveFieldsW931
    (leaves :
      MetrizableWppClosedMapTargetCompactObjectwiseUnitPrimitiveFieldLeavesW931) :
...
/-- W931 W732 route data after projecting W930 leaves. -/
def routeDataProviderOfClosedMapTargetCompactObjectwiseUnitPrimitiveFieldsW931
    (leaves :
      MetrizableWppClosedMapTargetCompactObjectwiseUnitPrimitiveFieldLeavesW931) :
...
/-- W931 exposes W930's localized-unit membership as objectwise membership. -/
def closedMapTargetCompactObjectwiseUnitPrimitiveFieldsInputNamesW931 :
    List String :=
  ["raw right-open closed-quotient-cover WPP-limit boundary proposition",
    ...
    "objectwise unit membership in boundedHomotopyExactWeakEquivalence"]

theorem closedMapTargetCompactObjectwiseUnitPrimitiveFieldsInputNamesW931_count :
    closedMapTargetCompactObjectwiseUnitPrimitiveFieldsInputNamesW931.length =
      39 :=
  rfl

/-- Current checked W931 state. -/
structure MetrizableClosedMapTargetCompactObjectwiseUnitPrimitiveFieldsRouteStateW931 :
    Type where
  seed : String
  declarations : List String
  objectwiseUnitPrimitiveFieldResult : String
  exactAtResult : String
  refinedInputs : List String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentMetrizableClosedMapTargetCompactObjectwiseUnitPrimitiveFieldsRouteStateW931 :
    MetrizableClosedMapTargetCompactObjectwiseUnitPrimitiveFieldsRouteStateW931
    where
  seed :=
    "w931-closed-map-target-compact-no-univ-membership-objectwise-unit-\
      primitive-field-route"
  declarations :=
    ["MetrizableWppClosedMapTargetCompactObjectwiseUnitPrimitiveFieldLeavesW931",
      "boundedHomotopyLocalizedUnitObjectwisePrimitiveW931",
      "boundedHomotopyLocalizedUnitMemOfObjectwisePrimitiveW931",
      "w930LeavesOfTargetCompactObjectwiseUnitPrimitiveFieldsW931",
      ...
      "directBoundedLeftCalculusOfClosedMapTargetCompactObjectwiseUnitPrimitiveFieldsW931",
      "boundedDerivedInfinityCategoryOfClosedMapTargetCompactObjectwiseUnitPrimitiveFieldsW931",
      "closedMapTargetCompactObjectwiseUnitPrimitiveFieldsInputNamesW931",
      "closedMapTargetCompactObjectwiseUnitPrimitiveFieldsInputNamesW931_count"]
  objectwiseUnitPrimitiveFieldResult :=
    "proved: objectwise boundedHomotopyExactWeakEquivalence membership supplies\
      W930's functor-category localized adjunction unit membership field"
  exactAtResult :=
    "proved: closed-map target-compact-no-univ-membership-objectwise-unit-\
      ...
      component-fields mapped-cokernel-field fields feed the W930 stable\
      ExactAt route"
  refinedInputs :=
    ["bounded-homotopy localized adjunction unit membership exposed as objectwise\
      boundedHomotopyExactWeakEquivalence membership"]
  remainingInputs :=
    closedMapTargetCompactObjectwiseUnitPrimitiveFieldsInputNamesW931
  productSuccessClaimed := false

theorem currentW931ClosedMapTargetCompactObjectwiseUnitPrimitiveFieldsRoute_productSuccess :
    (let state :=
        currentMetrizableClosedMapTargetCompactObjectwiseUnitPrimitiveFieldsRouteStateW931;
