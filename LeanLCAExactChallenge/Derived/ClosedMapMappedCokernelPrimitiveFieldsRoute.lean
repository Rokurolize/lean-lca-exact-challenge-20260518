...
/-!
W921 feeds the W920 closed-map relation-primitive-fields route while exposing
the mapped-cokernel `IsClosedMap` leaf as its primitive closed-set image
proposition.
-/
...
/-- W921 primitive form of the mapped explicit cokernel closed-map field. -/
abbrev mappedCokernelClosedMapPrimitiveW921
    {X Y : MetrizableLCA.{0}} (f : X ⟶ Y) : Prop :=
  ∀ U : Set X, IsClosed U → IsClosed ((f : X → Y) '' U)

/-- W921 assembles the mapped explicit cokernel closed-map field. -/
abbrev mappedCokernelClosedMapOfPrimitiveW921
    (mappedCokernelClosedMap :
      ∀ {X Y : MetrizableLCA.{0}} (f : X ⟶ Y),
        mappedCokernelClosedMapPrimitiveW921 f) :
    ∀ {X Y : MetrizableLCA.{0}} (f : X ⟶ Y),
      IsClosedMap (f : X → Y) := by
  intro X Y f
  simpa [mappedCokernelClosedMapPrimitiveW921, IsClosedMap] using
    mappedCokernelClosedMap f

/--
W921 replaces W920's mapped-cokernel `IsClosedMap` field with the primitive
closed-set image proposition hidden by that definition.
-/
structure MetrizableWppClosedMapMappedCokernelPrimitiveFieldLeavesW921 :
    Type 2 where
  rightOpenBoundary :
...
/-- W921 projects W920 leaves from the mapped-cokernel primitive field. -/
def w920LeavesOfMappedCokernelPrimitiveFieldsW921
    (leaves :
      MetrizableWppClosedMapMappedCokernelPrimitiveFieldLeavesW921) :
  ...
  mappedCokernelClosedMap :=
    mappedCokernelClosedMapOfPrimitiveW921 leaves.mappedCokernelClosedMap
...
/-- W921 W733 concrete leaves after projecting W920 leaves. -/
def concreteLeavesOfClosedMapMappedCokernelPrimitiveFieldsW921
...
/-- W921 W732 route data after projecting W920 leaves. -/
def routeDataProviderOfClosedMapMappedCokernelPrimitiveFieldsW921
    (leaves : MetrizableWppClosedMapMappedCokernelPrimitiveFieldLeavesW921) :
    MetrizableWppBoundaryRelationTargetClosednessNormalizedDataProviderW732 :=
  routeDataProviderOfClosedMapRelationPrimitiveFieldsW920
    (w920LeavesOfMappedCokernelPrimitiveFieldsW921 leaves)

theorem directBoundedLeftCalculusOfClosedMapMappedCokernelPrimitiveFieldsW921
    (leaves : MetrizableWppClosedMapMappedCokernelPrimitiveFieldLeavesW921) :
...
/-- W921 exposes W920's mapped-cokernel closed-map field as a primitive proposition. -/
def closedMapMappedCokernelPrimitiveFieldsInputNamesW921 :
    List String :=
...
theorem closedMapMappedCokernelPrimitiveFieldsInputNamesW921_count :
    closedMapMappedCokernelPrimitiveFieldsInputNamesW921.length =
      39 :=
  rfl

/-- Current checked W921 state. -/
structure MetrizableClosedMapMappedCokernelPrimitiveFieldsRouteStateW921 :
    Type where
  seed : String
  declarations : List String
  mappedCokernelPrimitiveFieldResult : String
  exactAtResult : String
  refinedInputs : List String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentMetrizableClosedMapMappedCokernelPrimitiveFieldsRouteStateW921 :
    MetrizableClosedMapMappedCokernelPrimitiveFieldsRouteStateW921
    where
  seed :=
    "w921-closed-map-mapped-cokernel-primitive-fields-relation-primitive-fields-\
      source-raw-fields"
  declarations :=
    ["MetrizableWppClosedMapMappedCokernelPrimitiveFieldLeavesW921",
      "mappedCokernelClosedMapPrimitiveW921",
      "mappedCokernelClosedMapOfPrimitiveW921",
      "w920LeavesOfMappedCokernelPrimitiveFieldsW921",
      ...
      "boundedDerivedInfinityCategoryOfClosedMapMappedCokernelPrimitiveFieldsW921",
      "closedMapMappedCokernelPrimitiveFieldsInputNamesW921",
      "closedMapMappedCokernelPrimitiveFieldsInputNamesW921_count"]
  mappedCokernelPrimitiveFieldResult :=
    "proved: the primitive closed-set image quantifier supplies W920's\
      mapped-cokernel IsClosedMap field"
  exactAtResult :=
    "proved: closed-map mapped-cokernel-primitive-fields source-raw-fields\
      ...
      component-fields mapped-cokernel-field fields feed the W920 stable\
      ExactAt route"
  refinedInputs :=
    ["primitive mapped explicit cokernel closed-set image condition"]
  remainingInputs :=
    closedMapMappedCokernelPrimitiveFieldsInputNamesW921
  productSuccessClaimed := false

theorem currentW921ClosedMapMappedCokernelPrimitiveFieldsRoute_productSuccess :
    (let state :=
        currentMetrizableClosedMapMappedCokernelPrimitiveFieldsRouteStateW921;
