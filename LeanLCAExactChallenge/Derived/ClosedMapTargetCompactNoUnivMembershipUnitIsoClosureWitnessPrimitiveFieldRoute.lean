...
/-!
W933 feeds the W932 closed-map target-compact unit-cone-iso-closure route while
exposing the unit mapping-cone exact-acyclic homotopy iso-closure predicate as
the explicit `ObjectProperty.isoClosure` witness hidden by
...
/--
W933 primitive witness form of the bounded-homotopy localized adjunction unit
mapping-cone exact-acyclic homotopy iso-closure field.
-/
abbrev boundedHomotopyLocalizedUnitIsoClosureWitnessPrimitiveW933
  ...
  ∀ X : BoundedComplexCategory MetrizableLCA.{0},
    ∃ K : HomotopyCategory MetrizableLCA.{0} (ComplexShape.up ℤ),
      exactAcyclicHomotopyObject MetrizableLCA.{0} K ∧
        Nonempty
...
/-- W933 assembles the W932 unit mapping-cone iso-closure field. -/
abbrev boundedHomotopyLocalizedUnitConeIsoClosureOfWitnessPrimitiveW933
    (boundedHomotopyLocalizedRightAdjoint :
      MorphismProperty.Localization
          ((exactAcyclicHomotopyIsoClosure MetrizableLCA.{0}).trW) ⥤
        BoundedComplexCategory MetrizableLCA.{0})
    (boundedHomotopyLocalizedAdjunction :
      boundedHomotopyLocalizedVerdierFunctor MetrizableLCA.{0} ⊣
        boundedHomotopyLocalizedRightAdjoint)
    (boundedHomotopyLocalizedUnitIsoClosureWitness :
      boundedHomotopyLocalizedUnitIsoClosureWitnessPrimitiveW933
        boundedHomotopyLocalizedRightAdjoint
        boundedHomotopyLocalizedAdjunction) :
    boundedHomotopyLocalizedUnitConeIsoClosurePrimitiveW932
      boundedHomotopyLocalizedRightAdjoint
      boundedHomotopyLocalizedAdjunction := by
  intro X
  simpa [exactAcyclicHomotopyIsoClosure, ObjectProperty.isoClosure] using
    boundedHomotopyLocalizedUnitIsoClosureWitness X

/--
W933 replaces W932's unit mapping-cone exact-acyclic homotopy iso-closure
membership with the equivalent explicit exact-acyclic homotopy object plus
homotopy-category isomorphism witness.
-/
structure MetrizableWppClosedMapTargetCompactUnitIsoClosureWitnessFieldLeavesW933 :
    Type 2 where
  rightOpenBoundary :
...
/-- W933 projects W932 leaves from the unit iso-closure witness primitive. -/
def w932LeavesOfUnitIsoClosureWitnessFieldsW933
    (leaves :
      MetrizableWppClosedMapTargetCompactUnitIsoClosureWitnessFieldLeavesW933) :
    MetrizableWppClosedMapTargetCompactUnitConeIsoClosureFieldLeavesW932
    where
  ...
  boundedHomotopyLocalizedUnitConeIsoClosure :=
    boundedHomotopyLocalizedUnitConeIsoClosureOfWitnessPrimitiveW933
      leaves.boundedHomotopyLocalizedRightAdjoint
      leaves.boundedHomotopyLocalizedAdjunction
      leaves.boundedHomotopyLocalizedUnitIsoClosureWitness

/-- W933 W733 concrete leaves after projecting W932 leaves. -/
def concreteLeavesOfClosedMapTargetCompactUnitIsoClosureWitnessFieldsW933
    (leaves :
      MetrizableWppClosedMapTargetCompactUnitIsoClosureWitnessFieldLeavesW933) :
...
/-- W933 W732 route data after projecting W932 leaves. -/
def routeDataProviderOfClosedMapTargetCompactUnitIsoClosureWitnessFieldsW933
    (leaves :
      MetrizableWppClosedMapTargetCompactUnitIsoClosureWitnessFieldLeavesW933) :
...
/-- W933 exposes W932's unit mapping-cone iso-closure membership as a witness. -/
def closedMapTargetCompactUnitIsoClosureWitnessFieldsInputNamesW933 :
    List String :=
  ["raw right-open closed-quotient-cover WPP-limit boundary proposition",
    ...
    "unit mapping-cone iso-closure witness: exact-acyclic object plus isomorphism"]

theorem closedMapTargetCompactUnitIsoClosureWitnessFieldsInputNamesW933_count :
    closedMapTargetCompactUnitIsoClosureWitnessFieldsInputNamesW933.length =
      39 :=
  rfl

/-- Current checked W933 state. -/
structure MetrizableClosedMapTargetCompactUnitIsoClosureWitnessFieldsRouteStateW933 :
    Type where
  seed : String
  declarations : List String
  unitIsoClosureWitnessFieldResult : String
  exactAtResult : String
  refinedInputs : List String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentMetrizableClosedMapTargetCompactUnitIsoClosureWitnessFieldsRouteStateW933 :
    MetrizableClosedMapTargetCompactUnitIsoClosureWitnessFieldsRouteStateW933
    where
  seed :=
    "w933-closed-map-target-compact-no-univ-membership-unit-iso-closure-witness-\
      primitive-field-route"
  declarations :=
    ["MetrizableWppClosedMapTargetCompactUnitIsoClosureWitnessFieldLeavesW933",
      "boundedHomotopyLocalizedUnitIsoClosureWitnessPrimitiveW933",
      "boundedHomotopyLocalizedUnitConeIsoClosureOfWitnessPrimitiveW933",
      "w932LeavesOfUnitIsoClosureWitnessFieldsW933",
      ...
      "directBoundedLeftCalculusOfClosedMapTargetCompactUnitIsoClosureWitnessFieldsW933",
      "boundedDerivedInfinityCategoryOfClosedMapTargetCompactUnitIsoClosureWitnessFieldsW933",
      "closedMapTargetCompactUnitIsoClosureWitnessFieldsInputNamesW933",
      "closedMapTargetCompactUnitIsoClosureWitnessFieldsInputNamesW933_count"]
  unitIsoClosureWitnessFieldResult :=
    "proved: an explicit exact-acyclic homotopy object plus isomorphism witness\
      supplies W932's unit mapping-cone exact-acyclic homotopy iso-closure field"
  exactAtResult :=
    "proved: closed-map target-compact-no-univ-membership-unit-iso-closure-witness-\
      primitive-field target-compact-no-univ-membership-primitive-field\
      ...
      component-fields mapped-cokernel-field fields feed the W932/W931/W930\
      stable ExactAt route"
  refinedInputs :=
    ["unit mapping-cone exact-acyclic homotopy iso-closure membership exposed as\
      an explicit exact-acyclic homotopy object plus isomorphism witness"]
  remainingInputs :=
    closedMapTargetCompactUnitIsoClosureWitnessFieldsInputNamesW933
  productSuccessClaimed := false

theorem currentW933ClosedMapTargetCompactUnitIsoClosureWitnessFieldsRoute_productSuccess :
    (let state :=
        currentMetrizableClosedMapTargetCompactUnitIsoClosureWitnessFieldsRouteStateW933;
