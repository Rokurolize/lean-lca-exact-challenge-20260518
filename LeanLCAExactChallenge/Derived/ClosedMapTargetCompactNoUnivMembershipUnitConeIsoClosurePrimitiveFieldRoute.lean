...
/-!
W932 feeds the W931 closed-map target-compact objectwise-unit route while
exposing the objectwise bounded-homotopy localized adjunction unit membership as
the mapping-cone exact-acyclic homotopy iso-closure predicate hidden by
...
/--
W932 primitive mapping-cone exact-acyclic homotopy iso-closure form of the
bounded-homotopy localized adjunction unit membership field.
-/
abbrev boundedHomotopyLocalizedUnitConeIsoClosurePrimitiveW932
...
/-- W932 assembles the W931 objectwise unit-membership field. -/
abbrev boundedHomotopyLocalizedUnitObjectwiseOfConeIsoClosurePrimitiveW932
    (boundedHomotopyLocalizedRightAdjoint :
      MorphismProperty.Localization
          ((exactAcyclicHomotopyIsoClosure MetrizableLCA.{0}).trW) ⥤
        BoundedComplexCategory MetrizableLCA.{0})
    ...
    (boundedHomotopyLocalizedUnitConeIsoClosure :
      boundedHomotopyLocalizedUnitConeIsoClosurePrimitiveW932
        boundedHomotopyLocalizedRightAdjoint
        boundedHomotopyLocalizedAdjunction) :
    boundedHomotopyLocalizedUnitObjectwisePrimitiveW931
      boundedHomotopyLocalizedRightAdjoint
      boundedHomotopyLocalizedAdjunction := by
  intro X
  exact (boundedHomotopyExactWeakEquivalence_iff_mappingCone_isoClosure
    MetrizableLCA.{0} (boundedHomotopyLocalizedAdjunction.unit.app X)).2
      (boundedHomotopyLocalizedUnitConeIsoClosure X)

/--
W932 replaces W931's objectwise bounded-homotopy localized adjunction unit
membership with the equivalent mapping-cone exact-acyclic homotopy iso-closure
predicate.
-/
structure MetrizableWppClosedMapTargetCompactUnitConeIsoClosureFieldLeavesW932 :
    Type 2 where
  rightOpenBoundary :
...
/-- W932 projects W931 leaves from the unit mapping-cone iso-closure primitive. -/
def w931LeavesOfUnitConeIsoClosureFieldsW932
    (leaves :
  ...
  boundedHomotopyLocalizedUnitObjectwise :=
    boundedHomotopyLocalizedUnitObjectwiseOfConeIsoClosurePrimitiveW932
      leaves.boundedHomotopyLocalizedRightAdjoint
      leaves.boundedHomotopyLocalizedAdjunction
      leaves.boundedHomotopyLocalizedUnitConeIsoClosure

/-- W932 W733 concrete leaves after projecting W931 leaves. -/
def concreteLeavesOfClosedMapTargetCompactUnitConeIsoClosureFieldsW932
    (leaves :
      MetrizableWppClosedMapTargetCompactUnitConeIsoClosureFieldLeavesW932) :
...
/-- W932 W732 route data after projecting W931 leaves. -/
def routeDataProviderOfClosedMapTargetCompactUnitConeIsoClosureFieldsW932
    (leaves :
      MetrizableWppClosedMapTargetCompactUnitConeIsoClosureFieldLeavesW932) :
...
/-- W932 exposes W931's objectwise localized-unit membership as mapping-cone iso-closure. -/
def closedMapTargetCompactUnitConeIsoClosureFieldsInputNamesW932 :
    List String :=
  ["raw right-open closed-quotient-cover WPP-limit boundary proposition",
    ...
    "unit mapping-cone exact-acyclic homotopy iso-closure membership"]

theorem closedMapTargetCompactUnitConeIsoClosureFieldsInputNamesW932_count :
    closedMapTargetCompactUnitConeIsoClosureFieldsInputNamesW932.length =
      39 :=
  rfl

/-- Current checked W932 state. -/
structure MetrizableClosedMapTargetCompactUnitConeIsoClosureFieldsRouteStateW932 :
    Type where
  seed : String
  declarations : List String
  unitConeIsoClosureFieldResult : String
  exactAtResult : String
  refinedInputs : List String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentMetrizableClosedMapTargetCompactUnitConeIsoClosureFieldsRouteStateW932 :
    MetrizableClosedMapTargetCompactUnitConeIsoClosureFieldsRouteStateW932
    where
  seed :=
    "w932-closed-map-target-compact-no-univ-membership-unit-cone-iso-closure-\
      primitive-field-route"
  declarations :=
    ["MetrizableWppClosedMapTargetCompactUnitConeIsoClosureFieldLeavesW932",
      "boundedHomotopyLocalizedUnitConeIsoClosurePrimitiveW932",
      "boundedHomotopyLocalizedUnitObjectwiseOfConeIsoClosurePrimitiveW932",
      "w931LeavesOfUnitConeIsoClosureFieldsW932",
      ...
      "directBoundedLeftCalculusOfClosedMapTargetCompactUnitConeIsoClosureFieldsW932",
      "boundedDerivedInfinityCategoryOfClosedMapTargetCompactUnitConeIsoClosureFieldsW932",
      "closedMapTargetCompactUnitConeIsoClosureFieldsInputNamesW932",
      "closedMapTargetCompactUnitConeIsoClosureFieldsInputNamesW932_count"]
  unitConeIsoClosureFieldResult :=
    "proved: unit mapping-cone exact-acyclic homotopy iso-closure membership\
      supplies W931's objectwise boundedHomotopyExactWeakEquivalence unit field"
  exactAtResult :=
    "proved: closed-map target-compact-no-univ-membership-unit-cone-iso-closure-\
      ...
      component-fields mapped-cokernel-field fields feed the W931/W930 stable\
      ExactAt route"
  refinedInputs :=
    ["objectwise boundedHomotopyExactWeakEquivalence unit membership exposed as\
      mapping-cone exact-acyclic homotopy iso-closure membership"]
  remainingInputs :=
    closedMapTargetCompactUnitConeIsoClosureFieldsInputNamesW932
  productSuccessClaimed := false

theorem currentW932ClosedMapTargetCompactUnitConeIsoClosureFieldsRoute_productSuccess :
    (let state :=
        currentMetrizableClosedMapTargetCompactUnitConeIsoClosureFieldsRouteStateW932;
