...
/-!
W897 feeds the W895 target-surjective-compact fields comparison stable-ExactAt
route from the closed-embedding branch fields of W725.
-/
...
/-- W897 assembles W725's closed-embedding branch from its two constructor fields. -/
def diagramAndMappedCokernelClosednessDataOfClosedEmbeddingFieldsW897
    (globalClosedEmbeddingComponents :
      SelectedDifferenceClosedEmbeddingDiagramComponentProviderW718)
    (mappedCokernelClosedEmbeddingProvider :
      MappedExplicitCokernelClosedEmbeddingProviderW519) :
    MetrizableWppDiagramAndMappedCokernelClosednessDataProviderW725 :=
  .closedEmbedding globalClosedEmbeddingComponents mappedCokernelClosedEmbeddingProvider

/--
W897 replaces W725's closedness branch input by the two explicit fields for
the closed-embedding constructor.
-/
structure MetrizableWppClosedEmbeddingClosednessFieldLeavesW897 :
    Type 2 where
  rightOpenBoundary :
...
/-- W897 projects the W895 leaves consumed by the latest route. -/
def targetSurjectiveCompactFieldLeavesOfClosedEmbeddingClosednessFieldsW897
...
/-- W897 W733 concrete leaves from explicit closed-embedding branch fields. -/
def concreteLeavesOfClosedEmbeddingClosednessFieldsComparisonW897
    (leaves : MetrizableWppClosedEmbeddingClosednessFieldLeavesW897) :
    MetrizableWppBoundaryRelationTargetClosednessNormalizedConcreteLeavesW733 :=
  concreteLeavesOfTargetSurjectiveCompactFieldsComparisonW895
    (targetSurjectiveCompactFieldLeavesOfClosedEmbeddingClosednessFieldsW897 leaves)

/-- W897 W732 route data from explicit closed-embedding branch fields. -/
def routeDataProviderOfClosedEmbeddingClosednessFieldsComparisonW897
    (leaves : MetrizableWppClosedEmbeddingClosednessFieldLeavesW897) :
...
/--
W897 direct bounded left calculus through the latest W895 comparison stable
ExactAt route.
-/
theorem directBoundedLeftCalculusOfClosedEmbeddingClosednessFieldsComparisonStableExactAtW897
    (leaves : MetrizableWppClosedEmbeddingClosednessFieldLeavesW897) :
...
/--
W897 bounded derived infinity-category package through the latest W895
...
/-- W897 exposes the W725 closed-embedding branch fields needed by W895. -/
def closedEmbeddingClosednessFieldsComparisonStableExactAtInputNamesW897 :
    List String :=
...
theorem closedEmbeddingClosednessFieldsComparisonStableExactAtInputNamesW897_count :
    closedEmbeddingClosednessFieldsComparisonStableExactAtInputNamesW897.length =
      38 :=
  rfl

/-- Current checked W897 state. -/
structure MetrizableClosedEmbeddingClosednessFieldsComparisonStableExactAtRouteStateW897 :
    Type where
  seed : String
...
def currentMetrizableClosedEmbeddingClosednessFieldsComparisonStableExactAtRouteStateW897 :
    MetrizableClosedEmbeddingClosednessFieldsComparisonStableExactAtRouteStateW897
    where
  seed :=
    "w897-closed-embedding-closedness-fields-comparison-stable-exact-at"
  declarations :=
  ...
  branchAssemblyResult :=
    "proved: explicit selected-difference closed-embedding components and W519 \
      mapped-cokernel closed-embedding fields assemble the W725 closed-embedding branch"
  exactAtResult :=
    "proved: explicit closed-embedding closedness fields feed the W895 stable ExactAt route"
  replacedInputs :=
    ["selected-difference closed-embedding components plus mapped-cokernel\
      closed-embedding provider"]
  remainingInputs :=
    closedEmbeddingClosednessFieldsComparisonStableExactAtInputNamesW897
  productSuccessClaimed := false

theorem currentW897ClosedEmbeddingClosednessFieldsComparisonStableExactAtRoute_productSuccess :
    (let state :=
        currentMetrizableClosedEmbeddingClosednessFieldsComparisonStableExactAtRouteStateW897;
