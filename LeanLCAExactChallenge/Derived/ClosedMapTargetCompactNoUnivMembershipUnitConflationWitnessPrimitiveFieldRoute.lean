...
/-!
W934 feeds the W933 closed-map target-compact unit-iso-closure-witness route
while exposing the witness object's exact-acyclic homotopy-object predicate as
the degreewise `QuillenExactCategory.Conflation` predicate hidden by
`exactAcyclicHomotopyObject` and `exactAcyclic`.
-/
...
/--
W934 primitive degreewise conflation witness form of the bounded-homotopy
localized adjunction unit iso-closure witness field.
-/
abbrev boundedHomotopyLocalizedUnitConflationWitnessPrimitiveW934
...
/-- W934 assembles the W933 unit iso-closure witness field. -/
abbrev boundedHomotopyLocalizedUnitIsoClosureWitnessOfConflationPrimitiveW934
    (boundedHomotopyLocalizedRightAdjoint :
      MorphismProperty.Localization
          ((exactAcyclicHomotopyIsoClosure MetrizableLCA.{0}).trW) ⥤
        BoundedComplexCategory MetrizableLCA.{0})
    ...
    (boundedHomotopyLocalizedUnitConflationWitness :
      boundedHomotopyLocalizedUnitConflationWitnessPrimitiveW934
        boundedHomotopyLocalizedRightAdjoint
        boundedHomotopyLocalizedAdjunction) :
  ...
  intro X
  rcases boundedHomotopyLocalizedUnitConflationWitness X with ⟨K, hK, hIso⟩
  exact ⟨K, by simpa [exactAcyclicHomotopyObject, exactAcyclic] using hK, hIso⟩

/--
W934 replaces W933's exact-acyclic homotopy object witness with the equivalent
degreewise Quillen conflation predicate on the witness object's underlying
cochain complex.
-/
structure MetrizableWppClosedMapTargetCompactUnitConflationWitnessFieldLeavesW934 :
    Type 2 where
  rightOpenBoundary :
...
/-- W934 projects W933 leaves from the unit conflation witness primitive. -/
def w933LeavesOfUnitConflationWitnessFieldsW934
    (leaves :
  ...
  boundedHomotopyLocalizedUnitIsoClosureWitness :=
    boundedHomotopyLocalizedUnitIsoClosureWitnessOfConflationPrimitiveW934
      leaves.boundedHomotopyLocalizedRightAdjoint
      leaves.boundedHomotopyLocalizedAdjunction
      leaves.boundedHomotopyLocalizedUnitConflationWitness

/-- W934 W733 concrete leaves after projecting W933 leaves. -/
def concreteLeavesOfClosedMapTargetCompactUnitConflationWitnessFieldsW934
    (leaves :
      MetrizableWppClosedMapTargetCompactUnitConflationWitnessFieldLeavesW934) :
...
/-- W934 W732 route data after projecting W933 leaves. -/
def routeDataProviderOfClosedMapTargetCompactUnitConflationWitnessFieldsW934
    (leaves :
      MetrizableWppClosedMapTargetCompactUnitConflationWitnessFieldLeavesW934) :
...
/-- W934 exposes W933's exact-acyclic object witness as degreewise conflations. -/
def closedMapTargetCompactUnitConflationWitnessFieldsInputNamesW934 :
    List String :=
...
theorem closedMapTargetCompactUnitConflationWitnessFieldsInputNamesW934_count :
    closedMapTargetCompactUnitConflationWitnessFieldsInputNamesW934.length =
      39 :=
  rfl

/-- Current checked W934 state. -/
structure MetrizableClosedMapTargetCompactUnitConflationWitnessFieldsRouteStateW934 :
    Type where
  seed : String
  declarations : List String
  unitConflationWitnessFieldResult : String
  exactAtResult : String
  refinedInputs : List String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentMetrizableClosedMapTargetCompactUnitConflationWitnessFieldsRouteStateW934 :
    MetrizableClosedMapTargetCompactUnitConflationWitnessFieldsRouteStateW934
    where
  seed :=
    "w934-closed-map-target-compact-no-univ-membership-unit-conflation-witness-\
      primitive-field-route"
  declarations :=
    ["MetrizableWppClosedMapTargetCompactUnitConflationWitnessFieldLeavesW934",
      "boundedHomotopyLocalizedUnitConflationWitnessPrimitiveW934",
      "boundedHomotopyLocalizedUnitIsoClosureWitnessOfConflationPrimitiveW934",
      "w933LeavesOfUnitConflationWitnessFieldsW934",
  ...
  unitConflationWitnessFieldResult :=
    "proved: degreewise Quillen conflations on the witness object's underlying\
      complex supply W933's exact-acyclic homotopy object field"
  exactAtResult :=
    "proved: closed-map target-compact-no-univ-membership-unit-conflation-witness-\
  ...
  refinedInputs :=
    ["unit mapping-cone iso-closure witness exact-acyclic homotopy object exposed\
      as degreewise Quillen conflations on the underlying cochain complex"]
  remainingInputs :=
    closedMapTargetCompactUnitConflationWitnessFieldsInputNamesW934
  productSuccessClaimed := false

theorem currentW934ClosedMapTargetCompactUnitConflationWitnessFieldsRoute_productSuccess :
    (let state :=
        currentMetrizableClosedMapTargetCompactUnitConflationWitnessFieldsRouteStateW934;
