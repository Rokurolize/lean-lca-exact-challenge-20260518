...
namespace MappingConeFiniteProduct
...
The final finite comparison proves this input by finite induction; the Option step consumes it
to reduce the comparison to the tail subproduct.
-/
