...
/-!
W894 feeds the W893 boundary-fields comparison stable-ExactAt route from
explicit closed-natural-transformation relation fields.
-/
...
/-- W894 assembles the bundled W717 relation data from its two fields. -/
def relationDataOfFieldsW894
...
/--
W894 replaces the W717 bundled relation-data input by its relation-pullback
and target-relation-lift constructor fields.
-/
structure MetrizableWppRelationFieldLeavesW894 :
    Type 2 where
  rightOpenBoundary :
...
/-- W894 projects the W893 leaves consumed by the latest route. -/
def boundaryFieldLeavesOfRelationFieldsW894
  ...
  relationData :=
    relationDataOfFieldsW894 leaves.relationPullbackProvider
...
/-- W894 W733 concrete leaves from explicit relation fields. -/
def concreteLeavesOfRelationFieldsComparisonW894
    (leaves : MetrizableWppRelationFieldLeavesW894) :
    MetrizableWppBoundaryRelationTargetClosednessNormalizedConcreteLeavesW733 :=
  concreteLeavesOfBoundaryFieldsComparisonW893
    (boundaryFieldLeavesOfRelationFieldsW894 leaves)

/-- W894 W732 route data from explicit relation fields. -/
def routeDataProviderOfRelationFieldsComparisonW894
    (leaves : MetrizableWppRelationFieldLeavesW894) :
...
/--
W894 direct bounded left calculus through the latest W893 comparison stable
ExactAt route.
-/
theorem directBoundedLeftCalculusOfRelationFieldsComparisonStableExactAtW894
    (leaves : MetrizableWppRelationFieldLeavesW894) :
...
/--
W894 bounded derived infinity-category package through the latest W893
...
/-- W894 exposes closed-natural-transformation relation fields needed by W893. -/
def relationFieldsComparisonStableExactAtInputNamesW894 :
    List String :=
...
theorem relationFieldsComparisonStableExactAtInputNamesW894_count :
    relationFieldsComparisonStableExactAtInputNamesW894.length =
      36 :=
  rfl

/-- Current checked W894 state. -/
structure MetrizableRelationFieldsComparisonStableExactAtRouteStateW894 :
    Type where
  seed : String
  declarations : List String
  relationAssemblyResult : String
  exactAtResult : String
  replacedInputs : List String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentMetrizableRelationFieldsComparisonStableExactAtRouteStateW894 :
    MetrizableRelationFieldsComparisonStableExactAtRouteStateW894
    where
  seed :=
    "w894-relation-fields-comparison-stable-exact-at"
  declarations :=
  ...
  relationAssemblyResult :=
    "proved: explicit relation-pullback and target-relation-lift fields assemble\
      the W717 relation data consumed by W893"
  exactAtResult :=
    "proved: explicit relation fields feed the W893 stable ExactAt route"
  replacedInputs :=
...
theorem currentW894RelationFieldsComparisonStableExactAtRoute_productSuccess :
    (let state :=
        currentMetrizableRelationFieldsComparisonStableExactAtRouteStateW894;
