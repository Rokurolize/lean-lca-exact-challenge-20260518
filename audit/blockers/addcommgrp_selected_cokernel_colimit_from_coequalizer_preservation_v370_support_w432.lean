...
/-!
W432: selected AddCommGrp cokernel colimit from an original WPP-op colimit,
with the W429 finite-colimit input discharged by W430-style coequalizer
preservation for the underlying forgetful functor.
...
coequalizer-preservation selected cokernel theorem.
-/
...
namespace AddCommGrpSelectedCokernelColimitFromCoequalizerPreservationV370SupportW432
...
/--
Primary W432 cokernel theorem: the original WPP-op colimit cocone induces the
...
/-- W432 checked support state. -/
structure AddCommGrpSelectedCokernelColimitFromCoequalizerPreservationV370SupportState : Type where
  seed : String
  checkedConstructors : List String
  selectedCokernelColimitFromCoequalizerPreservationResult : String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentAddCommGrpSelectedCokernelColimitFromCoequalizerPreservationV370SupportState :
    AddCommGrpSelectedCokernelColimitFromCoequalizerPreservationV370SupportState where
  seed := "w432-1e7923450baf6e873547640a"
  checkedConstructors :=
    ["metrizableLCA_hasColimitsOfShape_walkingParallelPair_op",
  ...
  selectedCokernelColimitFromCoequalizerPreservationResult := "proved"
  remainingInputs :=
    ["main thread must provide an original `hcs : IsColimit cs`",
      "main thread must provide `[PreservesColimitsOfShape WalkingParallelPair (forget₂ MetrizableLCA AddCommGrpCat)]`"]
  productSuccessClaimed := false

theorem currentAddCommGrpSelectedCokernelColimitFromCoequalizerPreservationV370SupportState_productSuccess :
    currentAddCommGrpSelectedCokernelColimitFromCoequalizerPreservationV370SupportState.productSuccessClaimed =
      false :=
  rfl
...
#check currentAddCommGrpSelectedCokernelColimitFromCoequalizerPreservationV370SupportState_productSuccess

end Checks

end AddCommGrpSelectedCokernelColimitFromCoequalizerPreservationV370SupportW432
