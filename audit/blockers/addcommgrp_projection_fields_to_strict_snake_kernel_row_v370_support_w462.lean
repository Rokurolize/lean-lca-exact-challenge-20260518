...
/-!
W462: projection fields to strict snake kernel-row frontier.

Seed: `d252822acab5ee2913273231`.
...
fields plus strict rows to strict SnakeInput cokernel data.
-/
...
namespace AddCommGrpProjectionFieldsToStrictSnakeKernelRowV370SupportW462
...
/-- W462 checked support state. -/
structure AddCommGrpProjectionFieldsToStrictSnakeKernelRowV370SupportState : Type where
  seed : String
...
/-- Current checked support state for W462. -/
def currentAddCommGrpProjectionFieldsToStrictSnakeKernelRowV370SupportState :
    AddCommGrpProjectionFieldsToStrictSnakeKernelRowV370SupportState where
  seed := supportSeed
  checkedDeclarations :=
    ["supportSeed",
      ...
      "strictSnakeCokernelData_of_projectionComponentFields_kernelRow",
      "addCommGrpKernelExact_of_projectionComponentFields_kernelRow"]
...
theorem currentAddCommGrpProjectionFieldsToStrictSnakeKernelRowV370SupportState_productSuccess :
    currentAddCommGrpProjectionFieldsToStrictSnakeKernelRowV370SupportState.productSuccessClaimed =
      false :=
  rfl
...
#check strictSnakeCokernelData_of_projectionComponentFields_kernelRow
#check addCommGrpKernelExact_of_projectionComponentFields_kernelRow
#check currentAddCommGrpProjectionFieldsToStrictSnakeKernelRowV370SupportState_productSuccess

end Checks

end AddCommGrpProjectionFieldsToStrictSnakeKernelRowV370SupportW462
