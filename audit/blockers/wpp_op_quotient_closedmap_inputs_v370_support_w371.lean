...
namespace WppOpQuotientClosedMapInputsV370SupportW371
...
/--
Concrete W371 input package for the concrete descended quotient map.

The square equations select the concrete quotient/coequalizer map; the other
fields are exactly the remaining W368 inputs.
-/
...
/-- The concrete W371 fields instantiate W368 for the concrete descended quotient map. -/
theorem ConcreteQuotientClosedMapInputsW371.to_w368_inputs
    {f g : A ⟶ B} {f' g' : A' ⟶ B'} {iA : A ⟶ A'} {iB : B ⟶ B'}
    {hsquare_left : f ≫ iB = iA ≫ f'}
    {hsquare_right : g ≫ iB = iA ≫ g'}
    (h :
    ...
    TargetRepresentativeSaturationComposerInputsW368 A B A' B' f g f' g' iB
      (concreteDescendedQuotientMap iA iB hsquare_left hsquare_right) where
  component_closedMap := h.component_closedMap
  relation_pullback := h.relation_pullback
  quotient_compat := concreteDescendedQuotientMap_quotient_compat
    iA iB hsquare_left hsquare_right
  target_relation_lifts := h.target_relation_lifts
  target_closed_on_saturated := h.target_closed_on_saturated

/--
Consumer theorem: W371's concrete inputs feed W368 and prove closedness of the
concrete quotient/coequalizer descended map.
-/
    ...
    IsClosedMap
      (concreteDescendedQuotientMap iA iB hsquare_left hsquare_right :
        quotientObj B (cokernelSubgroup (f - g))
          ...
          quotientObj B' (cokernelSubgroup (f' - g'))
            (AddSubgroup.isClosed_topologicalClosure _)) :=
  TargetRepresentativeSaturationComposerInputsW368.descended_closedMap
    h.to_w368_inputs
...
/-- WPP-op concrete inputs instantiate W368 for the concrete descended quotient map. -/
theorem WppOpConcreteQuotientClosedMapInputsW371.to_w368_inputs
    {X Y : WalkingParallelPairᵒᵖ ⥤ MetrizableLCA.{0}} {α : X ⟶ Y}
    {hsquare_left :
      wppOpLeft X ≫ wppOpOrdinaryCodomainMap α =
        wppOpOrdinaryDomainMap α ≫ wppOpLeft Y}
    ...
    (h :
      WppOpConcreteQuotientClosedMapInputsW371 α
        hsquare_left hsquare_right) :
    TargetRepresentativeSaturationComposerInputsW368
      ...
      (ConcreteMetrizableLCA.concreteDescendedQuotientMap
        (wppOpOrdinaryDomainMap α) (wppOpOrdinaryCodomainMap α)
        hsquare_left hsquare_right) :=
  ConcreteMetrizableLCA.ConcreteQuotientClosedMapInputsW371.to_w368_inputs h

/--
WPP-op consumer theorem for the concrete quotient/coequalizer descended map.
-/
...
/-- Machine-readable W371 state. -/
structure WppOpQuotientClosedMapInputsV370SupportStateW371 : Type where
  seed : String
  checkedFacts : List String
  packagedInputs : List String
  remainingInputs : List String
...
def currentWppOpQuotientClosedMapInputsV370SupportStateW371 :
    WppOpQuotientClosedMapInputsV370SupportStateW371 where
  seed := "OdAix35UXTXfz1Sh"
  checkedFacts :=
    ["ConcreteMetrizableLCA.concreteDescendedQuotientMap_quotient_compat",
      "ConcreteMetrizableLCA.ConcreteQuotientClosedMapInputsW371.to_w368_inputs",
      "ConcreteMetrizableLCA.ConcreteQuotientClosedMapInputsW371.descended_closedMap",
      "WppOpConcreteQuotientClosedMapInputsW371.to_w368_inputs",
      "WppOpConcreteQuotientClosedMapInputsW371.descended_closedMap"]
  packagedInputs :=
    ["component closed map for the WPP-op codomain component",
      "quotient compatibility from the concrete descended quotient map",
      "relation-pullback equality",
      "target relation lifting through the codomain component",
      "target quotient closed on closed saturated sets"]
  remainingInputs :=
    ["prove the WPP-op square equations or pass naturality equations at the call site",
      "supply component closedness for the concrete codomain component",
      "supply the concrete relation-pullback equality",
      "supply target relation lifting through the concrete codomain component"]
  productSuccessClaimed := false

theorem currentWppOpQuotientClosedMapInputsV370SupportStateW371_productSuccess :
    currentWppOpQuotientClosedMapInputsV370SupportStateW371.productSuccessClaimed = false := rfl

def wppOpQuotientClosedMapInputsV370SupportDeclarationNamesW371 : List String :=
  ["WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.concreteDescendedQuotientMap",
    "WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.concreteDescendedQuotientMap_quotient_compat",
    "WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.ConcreteQuotientClosedMapInputsW371",
    "WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.ConcreteQuotientClosedMapInputsW371.to_w368_inputs",
    "WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.ConcreteQuotientClosedMapInputsW371.descended_closedMap",
    "WppOpQuotientClosedMapInputsV370SupportW371.WppOpConcreteQuotientClosedMapInputsW371",
    "WppOpQuotientClosedMapInputsV370SupportW371.WppOpConcreteQuotientClosedMapInputsW371.to_w368_inputs",
    "WppOpQuotientClosedMapInputsV370SupportW371.WppOpConcreteQuotientClosedMapInputsW371.descended_closedMap",
    "WppOpQuotientClosedMapInputsV370SupportW371.currentWppOpQuotientClosedMapInputsV370SupportStateW371",
    "WppOpQuotientClosedMapInputsV370SupportW371.currentWppOpQuotientClosedMapInputsV370SupportStateW371_productSuccess"]

theorem wppOpQuotientClosedMapInputsV370SupportDeclarationNamesW371_count :
    wppOpQuotientClosedMapInputsV370SupportDeclarationNamesW371.length = 10 := rfl

section Checks

#check WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.concreteDescendedQuotientMap
#check WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.concreteDescendedQuotientMap_quotient_compat
#check WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.ConcreteQuotientClosedMapInputsW371
#check WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.ConcreteQuotientClosedMapInputsW371.to_w368_inputs
#check WppOpQuotientClosedMapInputsV370SupportW371.ConcreteMetrizableLCA.ConcreteQuotientClosedMapInputsW371.descended_closedMap
#check WppOpQuotientClosedMapInputsV370SupportW371.WppOpConcreteQuotientClosedMapInputsW371
#check WppOpQuotientClosedMapInputsV370SupportW371.WppOpConcreteQuotientClosedMapInputsW371.to_w368_inputs
#check WppOpQuotientClosedMapInputsV370SupportW371.WppOpConcreteQuotientClosedMapInputsW371.descended_closedMap
#check WppOpQuotientClosedMapInputsV370SupportW371.currentWppOpQuotientClosedMapInputsV370SupportStateW371
#check WppOpQuotientClosedMapInputsV370SupportW371.currentWppOpQuotientClosedMapInputsV370SupportStateW371_productSuccess
#check WppOpQuotientClosedMapInputsV370SupportW371.wppOpQuotientClosedMapInputsV370SupportDeclarationNamesW371
#check WppOpQuotientClosedMapInputsV370SupportW371.wppOpQuotientClosedMapInputsV370SupportDeclarationNamesW371_count

end Checks

end WppOpQuotientClosedMapInputsV370SupportW371
