...
namespace WppOpW399InputsFromReverseMembershipAndRelationFieldsV370SupportW421

/-
Porting map:

* W418 supplies the W399-shaped constructor from reverse closed-range membership
  and a closed-map proof for its concrete ordinary descended quotient map.
* W417 supplies the closed-map proof from the three relation fields
  `component_closedMap`, `relation_pullback`, and `target_relation_lifts`.
* The two local concrete descended maps are definitionally the same quotient
  lift, so the W417 closed-map output feeds W418 directly.
-/

/-- W417 and W418 use the same concrete ordinary descended quotient map. -/
theorem ordinaryDescendedOfOrdinaryMapW418_eq_W417
    {X Y : WalkingParallelPairᵒᵖ ⥤ MetrizableLCA.{0}}
    (ordinaryMap : WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.wppOpOrdinaryDiagram X ⟶ WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.wppOpOrdinaryDiagram Y) :
    WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.ordinaryDescendedOfOrdinaryMapW418 ordinaryMap =
      WppOpLeftLcaClosedMapFromRelationFieldsV370SupportW417.ordinaryDescendedOfOrdinaryMapW417 ordinaryMap := by
  rfl

/--
Checked W421 adapter: W407 reverse membership plus W417 relation fields produce
the W399 relation/topology input package for the concrete ordinary descended
map.
-/
theorem relationPullbackDescendedFieldsInputsW399_of_reverseMembership_and_relationFields
    {X Y : WalkingParallelPairᵒᵖ ⥤ MetrizableLCA.{0}}
    {ordinaryMap : WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.wppOpOrdinaryDiagram X ⟶ WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.wppOpOrdinaryDiagram Y}
    (hreverse : WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.WppOpRelationReverseClosedRangeMembershipW407 ordinaryMap)
    (hfields : WppOpLeftLcaClosedMapFromRelationFieldsV370SupportW417.ClosedMapRelationFieldsW417 ordinaryMap) :
    WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.WppOpRelationPullbackDescendedFieldsInputsW399 ordinaryMap := by
  have hclosed417 :
    ...
    WppOpLeftLcaClosedMapFromRelationFieldsV370SupportW417.ordinaryDescendedOfOrdinaryMap_isClosedMap_of_relationFieldsW417 hfields
  have hclosed418 :
      IsClosedMap (WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.ordinaryDescendedOfOrdinaryMapW418 ordinaryMap :
        WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.wppOpOrdinaryQuotientPoint X → WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.wppOpOrdinaryQuotientPoint Y) := by
    simpa [ordinaryDescendedOfOrdinaryMapW418_eq_W417] using hclosed417
  exact WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.relationPullbackDescendedFieldsInputsW399_of_reverseMembership_and_closedMap
    hreverse hclosed418

/-- Remaining upstream inputs after W421 combines W407 reverse membership and W417 relation fields. -/
def remainingInputsAfterW421Assembly : List String :=
  ["external callers still need to provide W407 reverse closed-range membership",
    "external callers still need to provide W417 component_closedMap, relation_pullback, and target_relation_lifts"]

theorem remainingInputsAfterW421Assembly_count :
    remainingInputsAfterW421Assembly.length = 2 := rfl

/-- Declaration names exported by this W421 support layer. -/
def w421SupportDeclarationNames : List String :=
  ["ordinaryDescendedOfOrdinaryMapW418_eq_W417",
    "relationPullbackDescendedFieldsInputsW399_of_reverseMembership_and_relationFields",
    "remainingInputsAfterW421Assembly"]

theorem w421SupportDeclarationNames_count :
    w421SupportDeclarationNames.length = 3 := rfl

/-- Worker-state summary for parent audit tooling. -/
structure WppOpW399InputsFromReverseMembershipAndRelationFieldsV370StateW421 : Type where
  seed : String
  declarations : List String
  remainingInputs : List String
  w399RelationFieldsCompositionResult : String
  subgoalSuccessClaimed : Bool
  productSuccessClaimed : Bool

/-- Current state: W421 checked the local adapter, with no product claim. -/
def currentWppOpW399InputsFromReverseMembershipAndRelationFieldsV370StateW421 :
    WppOpW399InputsFromReverseMembershipAndRelationFieldsV370StateW421 where
  seed := "1RNgfizDi8zTO9vCpTgBKavi"
  declarations := w421SupportDeclarationNames
  remainingInputs := remainingInputsAfterW421Assembly
  w399RelationFieldsCompositionResult := "proved"
  subgoalSuccessClaimed := true
  productSuccessClaimed := false

theorem currentWppOpW399InputsFromReverseMembershipAndRelationFieldsV370StateW421_productSuccess :
    currentWppOpW399InputsFromReverseMembershipAndRelationFieldsV370StateW421.productSuccessClaimed =
      false := rfl

section Checks

#check WppOpLeftLcaClosedMapFromRelationFieldsV370SupportW417.ClosedMapRelationFieldsW417
#check WppOpLeftLcaClosedMapFromRelationFieldsV370SupportW417.ordinaryDescendedOfOrdinaryMap_isClosedMap_of_relationFieldsW417
#check WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.WppOpRelationReverseClosedRangeMembershipW407
#check WppOpW399InputsFromReverseMembershipAndQuotientV370SupportW418.WppOpRelationPullbackDescendedFieldsInputsW399
#check ordinaryDescendedOfOrdinaryMapW418_eq_W417
#check relationPullbackDescendedFieldsInputsW399_of_reverseMembership_and_relationFields
#check remainingInputsAfterW421Assembly
#check remainingInputsAfterW421Assembly_count
#check w421SupportDeclarationNames
#check w421SupportDeclarationNames_count
#check currentWppOpW399InputsFromReverseMembershipAndRelationFieldsV370StateW421
#check currentWppOpW399InputsFromReverseMembershipAndRelationFieldsV370StateW421_productSuccess

end Checks

end WppOpW399InputsFromReverseMembershipAndRelationFieldsV370SupportW421
