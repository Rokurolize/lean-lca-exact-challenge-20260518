...
/-!
W385: AddCommGrp forgotten target `targetIso` support.
...
cokernel-cofork packages, then supplies checked adapters for the remaining
W382 `ForgottenTargetRowIsoInput.targetIso` field.
-/
...
namespace AddCommGrpForgottenTargetIsoV370SupportW385
...
/-- W385 checked support state. -/
structure AddCommGrpForgottenTargetIsoV370SupportState : Type where
  seed : String
  checkedConstructors : List String
  forgottenTargetIsoResult : String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentAddCommGrpForgottenTargetIsoV370SupportState :
    AddCommGrpForgottenTargetIsoV370SupportState where
  seed := "W385-SoT-4f247b7b512221ca"
  checkedConstructors :=
  ...
  forgottenTargetIsoResult := "partial"
  remainingInputs :=
    ["provide either a direct targetIso : W379Source.canonicalCokernelShortComplex u v ≅ cs.pt.map (forget₂ MetrizableLCA.{0} AddCommGrpCat.{0}) or a W376 presentation P plus hC : W379Source.canonicalCokernelShortComplex u v = P.C",
...
theorem currentAddCommGrpForgottenTargetIsoV370SupportState_productSuccess :
    currentAddCommGrpForgottenTargetIsoV370SupportState.productSuccessClaimed = false := rfl
...
#check currentAddCommGrpForgottenTargetIsoV370SupportState_productSuccess

end Checks

end AddCommGrpForgottenTargetIsoV370SupportW385
