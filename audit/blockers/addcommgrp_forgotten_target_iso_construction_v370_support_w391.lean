...
/-!
W391: AddCommGrp forgotten target iso-construction support.
...
namespace AddCommGrpForgottenTargetIsoConstructionV370SupportW391
...
/--
W391's smallest remaining construction input.  The WPP-op diagram, cocone, and
colimit proof are parameters; the only field is exactly the forgotten target
isomorphism requested by the downstream W388/W385 consumers.
-/
structure ForgottenTargetIsoConstructionInputW391
    {L₁ L₂ : ShortComplex AddCommGrpCat.{0}} (u v : L₁ ⟶ L₂)
    (S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0})
...
/-- W391's minimal iso package directly supplies the W385 row-iso input. -/
def ForgottenTargetIsoConstructionInputW391.toForgottenTargetRowIsoInput
    {L₁ L₂ : ShortComplex AddCommGrpCat.{0}} {u v : L₁ ⟶ L₂}
    {S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0}}
    {cs : Cocone S} (hcs : IsColimit cs)
    (I : ForgottenTargetIsoConstructionInputW391 u v S cs) :
    ForgottenTargetRowIsoInput u v S where
  cs := cs
  hcs := hcs
  targetIso := I.targetIso

/-- W391's minimal iso package feeds the canonical W376/W388 presentation route. -/
def wppOpForgottenTargetCokernelCoforkPresentation_of_isoConstructionInputW391
    {L₁ L₂ : ShortComplex AddCommGrpCat.{0}} (u v : L₁ ⟶ L₂)
    {S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0}}
    {cs : Cocone S} (hcs : IsColimit cs)
    (I : ForgottenTargetIsoConstructionInputW391 u v S cs) :
    W376Target.WppOpForgottenTargetCokernelCoforkPresentation u v :=
  wppOpForgottenTargetCokernelCoforkPresentation_of_w379Canonical u v S
    (I.toForgottenTargetRowIsoInput hcs)
...
structure CIdentificationInputW391
...
def CIdentificationInputW391.toForgottenTargetRowIsoInput
    {L₁ L₂ : ShortComplex AddCommGrpCat.{0}} {u v : L₁ ⟶ L₂}
    (I : CIdentificationInputW391 u v) :
    ForgottenTargetRowIsoInput u v I.presentation.S :=
  forgottenTargetRowIsoInput_of_w376Presentation I.presentation I.hC

/-- Canonical W376 presentations supply the checked W391 `C`-identification package. -/
def cIdentificationInputW391_of_w376CanonicalTargetPresentation
    {L₁ L₂ : ShortComplex AddCommGrpCat.{0}} (u v : L₁ ⟶ L₂)
    (S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0})
    (cs : Cocone S) (hcs : IsColimit cs)
    (targetIso :
      W379Source.canonicalCokernelShortComplex u v ≅
        cs.pt.map (forget₂ MetrizableLCA.{0} AddCommGrpCat.{0})) :
    CIdentificationInputW391 u v where
...
/-- W391's minimal iso package supplies the checked `C`-identification package. -/
def cIdentificationInputW391_of_isoConstructionInput
    {L₁ L₂ : ShortComplex AddCommGrpCat.{0}} (u v : L₁ ⟶ L₂)
    {S : WalkingParallelPairᵒᵖ ⥤ ShortComplex MetrizableLCA.{0}}
    {cs : Cocone S} (hcs : IsColimit cs)
    (I : ForgottenTargetIsoConstructionInputW391 u v S cs) :
    CIdentificationInputW391 u v where
  presentation :=
    wppOpForgottenTargetCokernelCoforkPresentation_of_isoConstructionInputW391
      u v hcs I
  hC := rfl

/--
Preferred W391 consumer into W385's
...
/-- W391 checked support state. -/
structure AddCommGrpForgottenTargetIsoConstructionV370SupportState : Type where
  seed : String
  checkedConstructors : List String
  forgottenTargetIsoConstructionResult : String
  remainingInputs : List String
  productSuccessClaimed : Bool

def currentAddCommGrpForgottenTargetIsoConstructionV370SupportState :
    AddCommGrpForgottenTargetIsoConstructionV370SupportState where
  seed := "5sbBVhMbMQiAbAZM7J3J9MfW"
  checkedConstructors :=
    ["W379Source.canonicalConcreteDegreewiseCokernelCoforkData",
      ...
      "ForgottenTargetIsoConstructionInputW391",
      "ForgottenTargetIsoConstructionInputW391.toForgottenTargetRowIsoInput",
      "wppOpForgottenTargetCokernelCoforkPresentation_of_isoConstructionInputW391",
      "w376CanonicalTargetPresentation",
      "w376CanonicalTargetPresentation_hC",
      "CIdentificationInputW391",
      "CIdentificationInputW391.toForgottenTargetRowIsoInput",
      "cIdentificationInputW391_of_w376CanonicalTargetPresentation",
      "cIdentificationInputW391_of_isoConstructionInput",
      "wppOpForgottenTargetCokernelCoforkPresentation_of_w376CanonicalTargetPresentation"]
  forgottenTargetIsoConstructionResult := "partial"
  remainingInputs :=
...
theorem currentAddCommGrpForgottenTargetIsoConstructionV370SupportState_productSuccess :
    currentAddCommGrpForgottenTargetIsoConstructionV370SupportState.productSuccessClaimed = false := rfl
...
#check ForgottenTargetIsoConstructionInputW391
#check ForgottenTargetIsoConstructionInputW391.targetIso
#check ForgottenTargetIsoConstructionInputW391.toForgottenTargetRowIsoInput
#check wppOpForgottenTargetCokernelCoforkPresentation_of_isoConstructionInputW391
#check w376CanonicalTargetPresentation
#check w376CanonicalTargetPresentation_hC
#check CIdentificationInputW391
#check CIdentificationInputW391.toForgottenTargetRowIsoInput
#check cIdentificationInputW391_of_w376CanonicalTargetPresentation
#check cIdentificationInputW391_of_isoConstructionInput
#check wppOpForgottenTargetCokernelCoforkPresentation_of_w376CanonicalTargetPresentation
#check currentAddCommGrpForgottenTargetIsoConstructionV370SupportState_productSuccess

end Checks

end AddCommGrpForgottenTargetIsoConstructionV370SupportW391
